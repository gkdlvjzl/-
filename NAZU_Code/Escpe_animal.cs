...
public class Escpe_animal : MonoBehaviour
{
    ...
    {        
        ...
        if(vir < Deitak_range)
        {
            ...
            Vector3 newPos = new Vector3 (transform.position.x + (this.transform.position.x - Attacker.transform.position.x), this.transform.position.y, transform.position.z + (this.transform.position.z - Attacker.transform.position.z));
